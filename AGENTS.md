...
- `date` (optional date line shown in the web header below description)
- `album_title`, `album_artist`, `album_style` (music pairing shown on intro page)
- `album_youtube_url` (optional YouTube/YouTube Music URL; rendered as a web play button in HTML output)
