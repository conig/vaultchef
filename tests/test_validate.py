...
# Purpose: verify validate recipe ok.
...
# Purpose: verify validate missing frontmatter.
...
# Purpose: verify validate invalid yaml.
...
# Purpose: verify validate frontmatter not mapping.
...
# Purpose: verify validate missing keys.
...
# Purpose: verify validate missing sections.
...
# Purpose: verify validate missing bullets.
...
# Purpose: verify validate missing method steps.
...
# Purpose: verify extract sections.
