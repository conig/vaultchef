...
\newif\ifVaultChefHasMulticol
\IfFileExists{multicol.sty}{
  \usepackage{multicol}
  \VaultChefHasMulticoltrue
}{
  \VaultChefHasMulticolfalse
}
...
\newcounter{VaultChefIntroStartPage}
...
\setcounter{VaultChefIntroStartPage}{\value{page}}
\thispagestyle{plain}
\begin{center}
...
\item \textbf{Listen:} \url{$album_youtube_url$}
$endif$
\end{itemize}
\endgroup
$endif$
...
$endfor$
$else$
\item No shopping items detected.
$endif$
\end{itemize}
\ifVaultChefHasMulticol
\end{multicols}
...
\clearpage
\ifnum\numexpr\value{page}-\value{VaultChefIntroStartPage}\relax<2
\thispagestyle{empty}\null
\clearpage
\fi
$endif$
